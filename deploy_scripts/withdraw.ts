...
//     const BRIDGE_CONTRACT_AMOY_address = `0x03A60f96419Fe03F4174f97A0aC547dC4d3f08e5`;
//     const GATEWAY_AMOY_address = `0xADf26E2F7600dc8f8b835BdC3FaC5b39730e874b`;
...
//   // console.log("address", await deployerSigner.getAddress());
...
// //   ).ccipChainSelectorAMOY, BRIDGE_CONTRACT_AMOY_address, GATEWAY_AMOY_address);
  ...
  const instance_bridge = await ethers.getContractAt(
    'CrossChainBridge',
    '0x5Fbe7C8e8825e6fDB527De6fA04C0A5b506763C1',
    deployerSigner, // Use deployer's signer
  );
  await instance_bridge.withdraw(deployerWallet, ethers.parseEther('0.099859873401144126'));
...
// //     bobWalletSigner,
// //   )
// //   console.log('Identity OP_SEPOLIA Address:', await instance_identity.getAddress());
...
//     // const tx_ret = await instance_factory.getIdentity(bobWallet);
