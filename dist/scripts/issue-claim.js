...
async function main() {
    ...
    const claimIssuerJSON = JSON.parse(fs_1.default.readFileSync('deployments/amoy/ClaimIssuer.json', 'utf8'));
    ...
    const IdFactoryJSON = JSON.parse(fs_1.default.readFileSync('deployments/amoy/IdFactory.json', 'utf8'));
    ...
    const identityJSON = JSON.parse(fs_1.default.readFileSync('deployments/amoy/Identity.json', 'utf8'));
    const aliceIdentity = await hardhat_1.ethers.getContractAt(identityJSON.abi, aliceIdentityAddress);
